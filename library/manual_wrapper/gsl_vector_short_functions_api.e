...
feature -- Externals
	...
	c_gsl_vector_short_scale (a: POINTER; x: INTEGER): INTEGER
		external
			"C inline use <eif_gsl.h>"
		alias
			"[
				return gsl_vector_short_scale ((gsl_vector_short*)$a, (short const)$x);
			]"
		end
	...
	c_gsl_vector_short_axpby (alpha: INTEGER; x: POINTER; beta: INTEGER; y: POINTER): INTEGER
		external
			"C inline use <eif_gsl.h>"
		alias
			"[
				return gsl_vector_short_axpby ((short const)$alpha, (gsl_vector_short const*)$x, (short const)$beta, (gsl_vector_short*)$y);
			]"
		end
