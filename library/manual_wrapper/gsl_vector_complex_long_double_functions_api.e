...
feature -- Access
	...
	gsl_vector_complex_long_double_fread (stream: FILE; v: GSL_VECTOR_COMPLEX_LONG_DOUBLE_STRUCT_API): INTEGER
		do
			Result := c_gsl_vector_complex_long_double_fread (stream.file_pointer, v.item)
		end

	gsl_vector_complex_long_double_fwrite (stream: FILE; v: GSL_VECTOR_COMPLEX_LONG_DOUBLE_STRUCT_API): INTEGER
		do
			Result := c_gsl_vector_complex_long_double_fwrite (stream.file_pointer, v.item)
		end

	gsl_vector_complex_long_double_fscanf (stream: FILE; v: GSL_VECTOR_COMPLEX_LONG_DOUBLE_STRUCT_API): INTEGER
		do
			Result := c_gsl_vector_complex_long_double_fscanf (stream.file_pointer, v.item)
		end

	gsl_vector_complex_long_double_fprintf (stream: FILE; v: GSL_VECTOR_COMPLEX_LONG_DOUBLE_STRUCT_API; format: STRING): INTEGER
		local
			format_c_string: C_STRING
		do
			create format_c_string.make (format)
			Result := c_gsl_vector_complex_long_double_fprintf (stream.file_pointer, v.item, format_c_string.item)
		end
	...
	gsl_vector_complex_long_double_axpby (alpha: GSL_COMPLEX_LONG_DOUBLE_STRUCT_API; x: GSL_VECTOR_COMPLEX_LONG_DOUBLE_STRUCT_API; beta: GSL_COMPLEX_LONG_DOUBLE_STRUCT_API; y: GSL_VECTOR_COMPLEX_LONG_DOUBLE_STRUCT_API): INTEGER
		do
			Result := c_gsl_vector_complex_long_double_axpby (alpha.item, x.item, beta.item, y.item)
		end
...
feature -- Externals
	...
	c_gsl_vector_complex_long_double_axpby (alpha: POINTER; x: POINTER; beta: POINTER; y: POINTER): INTEGER
		external
			"C inline use <eif_gsl.h>"
		alias
			"[
				return gsl_vector_complex_long_double_axpby (*(gsl_complex_long_double const*)$alpha, (gsl_vector_complex_long_double const*)$x, *(gsl_complex_long_double const*)$beta, (gsl_vector_complex_long_double*)$y);
			]"
		end
