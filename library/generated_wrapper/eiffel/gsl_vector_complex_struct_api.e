...
class GSL_VECTOR_COMPLEX_STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct gsl_vector_complex
	...
	c_size (an_item: POINTER): INTEGER
		...
		alias
			"[
				((gsl_vector_complex*)$an_item)->size
			]"
		end
	...
	set_c_size (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gsl_vector_complex*)$an_item)->size =  (size_t)$a_value
			]"
		ensure
	...
	c_stride (an_item: POINTER): INTEGER
		...
		alias
			"[
				((gsl_vector_complex*)$an_item)->stride
			]"
		end
	...
	set_c_stride (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gsl_vector_complex*)$an_item)->stride =  (size_t)$a_value
			]"
		ensure
	...
	c_data (an_item: POINTER): POINTER
		...
		alias
			"[
				((gsl_vector_complex*)$an_item)->data
			]"
		end
	...
	set_c_data (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((gsl_vector_complex*)$an_item)->data =  (double*)$a_value
			]"
		ensure
	...
	c_block (an_item: POINTER): POINTER
		...
		alias
			"[
				((gsl_vector_complex*)$an_item)->block
			]"
		end
	...
	set_c_block (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((gsl_vector_complex*)$an_item)->block =  (gsl_block_complex*)$a_value
			]"
		ensure
	...
	c_owner (an_item: POINTER): INTEGER
		...
		alias
			"[
				((gsl_vector_complex*)$an_item)->owner
			]"
		end
	...
	set_c_owner (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gsl_vector_complex*)$an_item)->owner =  (int)$a_value
			]"
		ensure
