...
class GSL_VECTOR_VIEW_STRUCT_API
...
feature {ANY} -- Member Access
	...
	set_vector (a_value: GSL_VECTOR_STRUCT_API) 
			-- Set member `vector`
		require
...
feature {NONE} -- Implementation wrapper for struct _gsl_vector_view

	sizeof_external: INTEGER 
		external
			"C inline use <eif_gsl.h>"
		alias
			"sizeof(_gsl_vector_view)"
		end
	...
	c_vector (an_item: POINTER): POINTER
		...
		alias
			"[
				&((_gsl_vector_view*)$an_item)->vector
			]"
		end
	...
	set_c_vector (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((_gsl_vector_view*)$an_item)->vector =  *(gsl_vector*)$a_value
			]"
		end
