...
class GSL_VECTOR_INT_STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct gsl_vector_int

	sizeof_external: INTEGER 
		external
			"C inline use <eif_gsl.h>"
		alias
			"sizeof(gsl_vector_int)"
		end
	...
	set_c_size (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gsl_vector_int*)$an_item)->size =  (size_t)$a_value
			]"
		ensure
	...
	set_c_stride (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gsl_vector_int*)$an_item)->stride =  (size_t)$a_value
			]"
		ensure
	...
	set_c_data (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((gsl_vector_int*)$an_item)->data =  (int*)$a_value
			]"
		ensure
	...
	set_c_block (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((gsl_vector_int*)$an_item)->block =  (gsl_block_int*)$a_value
			]"
		ensure
	...
	set_c_owner (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gsl_vector_int*)$an_item)->owner =  (int)$a_value
			]"
		ensure
