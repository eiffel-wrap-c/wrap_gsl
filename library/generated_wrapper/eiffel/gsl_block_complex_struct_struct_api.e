...
class GSL_BLOCK_COMPLEX_STRUCT_STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct gsl_block_complex_struct

	sizeof_external: INTEGER 
		external
			"C inline use <eif_gsl.h>"
		alias
			"sizeof(struct gsl_block_complex_struct)"
		end
	...
	c_size (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct gsl_block_complex_struct*)$an_item)->size
			]"
		end
	...
	set_c_size (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct gsl_block_complex_struct*)$an_item)->size =  (size_t)$a_value
			]"
		ensure
	...
	c_data (an_item: POINTER): POINTER
		...
		alias
			"[
				((struct gsl_block_complex_struct*)$an_item)->data
			]"
		end
	...
	set_c_data (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((struct gsl_block_complex_struct*)$an_item)->data =  (double*)$a_value
			]"
		ensure
