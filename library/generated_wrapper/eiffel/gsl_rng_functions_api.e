...
feature -- Access
	...
	gsl_rng_fread (stream: IOBUF_STRUCT_API; r: GSL_RNG_STRUCT_API): INTEGER 
		do
			Result := c_gsl_rng_fread (stream.item, r.item)
		end

	gsl_rng_fwrite (stream: IOBUF_STRUCT_API; r: GSL_RNG_STRUCT_API): INTEGER 
		do
			Result := c_gsl_rng_fwrite (stream.item, r.item)
		end
