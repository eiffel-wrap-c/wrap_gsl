...
class GSL_BLOCK_USHORT_STRUCT_STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct gsl_block_ushort_struct

	sizeof_external: INTEGER 
		external
			"C inline use <eif_gsl.h>"
		alias
			"sizeof(struct gsl_block_ushort_struct)"
		end
	...
	c_size (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct gsl_block_ushort_struct*)$an_item)->size
			]"
		end
	...
	set_c_size (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct gsl_block_ushort_struct*)$an_item)->size =  (size_t)$a_value
			]"
		ensure
	...
	c_data (an_item: POINTER): POINTER
		...
		alias
			"[
				((struct gsl_block_ushort_struct*)$an_item)->data
			]"
		end
	...
	set_c_data (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((struct gsl_block_ushort_struct*)$an_item)->data =  (unsigned short*)$a_value
			]"
		ensure
