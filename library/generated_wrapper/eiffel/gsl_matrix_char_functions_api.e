...
feature -- Access
	...
	gsl_matrix_char_fread (stream: IOBUF_STRUCT_API; m: GSL_MATRIX_CHAR_STRUCT_API): INTEGER 
		do
			Result := c_gsl_matrix_char_fread (stream.item, m.item)
		end

	gsl_matrix_char_fwrite (stream: IOBUF_STRUCT_API; m: GSL_MATRIX_CHAR_STRUCT_API): INTEGER 
		do
			Result := c_gsl_matrix_char_fwrite (stream.item, m.item)
		end

	gsl_matrix_char_fscanf (stream: IOBUF_STRUCT_API; m: GSL_MATRIX_CHAR_STRUCT_API): INTEGER 
		do
			Result := c_gsl_matrix_char_fscanf (stream.item, m.item)
		end

	gsl_matrix_char_fprintf (stream: IOBUF_STRUCT_API; m: GSL_MATRIX_CHAR_STRUCT_API; format: STRING): INTEGER 
		local
			format_c_string: C_STRING
		do
			create format_c_string.make (format)
			Result := c_gsl_matrix_char_fprintf (stream.item, m.item, format_c_string.item)
		end
	...
	gsl_matrix_char_tricpy (uplo_src: CHARACTER; copy_diag: INTEGER; dest: GSL_MATRIX_CHAR_STRUCT_API; src: GSL_MATRIX_CHAR_STRUCT_API): INTEGER 
		do
			Result := c_gsl_matrix_char_tricpy (uplo_src, copy_diag, dest.item, src.item)
		end
	...
	gsl_matrix_char_transpose_tricpy (uplo_src: CHARACTER; copy_diag: INTEGER; dest: GSL_MATRIX_CHAR_STRUCT_API; src: GSL_MATRIX_CHAR_STRUCT_API): INTEGER 
		do
			Result := c_gsl_matrix_char_transpose_tricpy (uplo_src, copy_diag, dest.item, src.item)
		end
...
feature -- Externals
	...
	c_gsl_matrix_char_tricpy (uplo_src: CHARACTER; copy_diag: INTEGER; dest: POINTER; src: POINTER): INTEGER
		external
			"C inline use <eif_gsl.h>"
		alias
			"[
				return gsl_matrix_char_tricpy ((char const)$uplo_src, (int const)$copy_diag, (gsl_matrix_char*)$dest, (gsl_matrix_char const*)$src);
			]"
		end
	...
	c_gsl_matrix_char_transpose_tricpy (uplo_src: CHARACTER; copy_diag: INTEGER; dest: POINTER; src: POINTER): INTEGER
		external
			"C inline use <eif_gsl.h>"
		alias
			"[
				return gsl_matrix_char_transpose_tricpy ((char const)$uplo_src, (int const)$copy_diag, (gsl_matrix_char*)$dest, (gsl_matrix_char const*)$src);
			]"
		end
