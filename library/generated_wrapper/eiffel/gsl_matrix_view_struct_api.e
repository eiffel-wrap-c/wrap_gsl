...
class GSL_MATRIX_VIEW_STRUCT_API
...
feature {ANY} -- Member Access
	...
	set_matrix (a_value: GSL_MATRIX_STRUCT_API) 
			-- Set member `matrix`
		require
...
feature {NONE} -- Implementation wrapper for struct _gsl_matrix_view

	sizeof_external: INTEGER 
		external
			"C inline use <eif_gsl.h>"
		alias
			"sizeof(_gsl_matrix_view)"
		end
	...
	c_matrix (an_item: POINTER): POINTER
		...
		alias
			"[
				&((_gsl_matrix_view*)$an_item)->matrix
			]"
		end
	...
	set_c_matrix (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((_gsl_matrix_view*)$an_item)->matrix =  *(gsl_matrix*)$a_value
			]"
		end
