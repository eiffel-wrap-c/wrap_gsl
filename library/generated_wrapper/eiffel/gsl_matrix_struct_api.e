...
feature {NONE} -- Implementation wrapper for struct gsl_matrix
	...
	set_c_size1 (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gsl_matrix*)$an_item)->size1 =  (size_t)$a_value
			]"
		ensure
	...
	set_c_size2 (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gsl_matrix*)$an_item)->size2 =  (size_t)$a_value
			]"
		ensure
	...
	set_c_tda (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gsl_matrix*)$an_item)->tda =  (size_t)$a_value
			]"
		ensure
	...
	set_c_data (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((gsl_matrix*)$an_item)->data =  (double*)$a_value
			]"
		ensure
	...
	set_c_block (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((gsl_matrix*)$an_item)->block =  (gsl_block*)$a_value
			]"
		ensure
	...
	set_c_owner (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gsl_matrix*)$an_item)->owner =  (int)$a_value
			]"
		ensure
