...
class GSL_MATRIX_UINT_STRUCT_API
...
feature {ANY} -- Member Access
	...
	block: detachable GSL_BLOCK_UINT_STRUCT_STRUCT_API 
			-- Access member `block`
		require
			exists: exists
		do
	...
	set_block (a_value: GSL_BLOCK_UINT_STRUCT_STRUCT_API) 
			-- Set member `block`
		require
...
feature {NONE} -- Implementation wrapper for struct gsl_matrix_uint

	sizeof_external: INTEGER 
		external
			"C inline use <eif_gsl.h>"
		alias
			"sizeof(gsl_matrix_uint)"
		end
	...
	set_c_size1 (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gsl_matrix_uint*)$an_item)->size1 =  (size_t)$a_value
			]"
		ensure
	...
	set_c_size2 (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gsl_matrix_uint*)$an_item)->size2 =  (size_t)$a_value
			]"
		ensure
	...
	set_c_tda (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gsl_matrix_uint*)$an_item)->tda =  (size_t)$a_value
			]"
		ensure
	...
	set_c_data (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((gsl_matrix_uint*)$an_item)->data =  (unsigned int*)$a_value
			]"
		ensure
	...
	set_c_block (an_item: POINTER; a_value: POINTER) 
		...
		alias
			"[
				((gsl_matrix_uint*)$an_item)->block =  (gsl_block_uint*)$a_value
			]"
		ensure
	...
	set_c_owner (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gsl_matrix_uint*)$an_item)->owner =  (int)$a_value
			]"
		ensure
